...
function getir(a,b,c,d,id) {

    document.getElementById("anlam_b").innerHTML = "Anlamı:";
    document.getElementById("dil_b").innerHTML = "Dilimize geçtiği köken:";
    document.getElementById("ornek_b").innerHTML = "Örnek Cümle:";
    document.getElementById("kelime").innerHTML = a;
    document.getElementById("anlam").innerHTML = b;
    document.getElementById("dil").innerHTML = c;
    document.getElementById("ornek").innerHTML = d;
...
var id_degeri = 0;
var random_indiis = 0;
function random_yaz(indis_id) {
    id_degeri = indis_id;
    //rasge_dizi.push(indis_id);

}
function random_duzenle() {
    //alert(rasge_dizi.length)
    random_indiis = Math.floor(Math.random() * (id_degeri));
...
function random_getir() {
    id_kilitleme = 0;
    return random_indiis;

}

function rasgele_kelime_yaz(a, b, c, d, id) {
    ...
    else if (id_degeri == id && id_kilitleme == 0) {
        getir(a, b, c, d, id);
